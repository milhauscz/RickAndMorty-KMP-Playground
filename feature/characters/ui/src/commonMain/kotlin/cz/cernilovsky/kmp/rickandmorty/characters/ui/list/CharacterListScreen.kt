...
internal data class CharacterListActions(
...
@Composable
internal fun EmptyFilteredMessage() {
    Box(
        modifier = Modifier.fillMaxSize(),
...
@Composable
internal fun LoadingItemsIndicator() {
    Box(
        modifier = Modifier.fillMaxWidth(),
        contentAlignment = Alignment.Center,
    ) {
...
@Composable
internal fun LoadingItemsError(
...
@Preview
@Composable
internal fun CharacterListSuccessPreview() {
...
@Preview
@Composable
internal fun CharacterListErrorPreview() {
    MaterialTheme {
        val characters =
            flowOf(
                PagingData.from(
